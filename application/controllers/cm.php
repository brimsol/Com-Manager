...
class Cm extends CI_Controller {
	...
	public function associations() {
		...
		//$output = $this -> grocery_crud -> render();
		$crud = new grocery_CRUD();
		$crud -> set_table('fellowships') -> set_subject('Association') -> columns('fellowship_name', 'fellowship_description') 
		-> display_as('fellowship_name', 'Association Name') 
		-> display_as('fellowship_description', 'Association Description'); 
	...
	public function districts() {
		...
		//$output = $this -> grocery_crud -> render();
		$crud = new grocery_CRUD();
		$crud -> set_table('districts') -> set_subject('District') -> columns('district_name', 'district_code') 
		-> display_as('district_name', 'District Name') 
		-> display_as('district_code', 'District Code'); 
	...
	public function participants() {
		...
		//$output = $this -> grocery_crud -> render();
		$crud = new grocery_CRUD();
		$crud -> set_table('participants') -> set_subject('Participant') 
		-> columns('participant_chess', 'participant_name', 'participant_association','participant_church', 'participant_district', 'participant_dob', 'participant_age', 'participant_youth') 
		-> display_as('participant_chess', 'Chess No.') 
		-> display_as('participant_association', 'Asso.')
		-> display_as('participant_name', 'Name')
		-> display_as('participant_church', 'Church')
		-> display_as('participant_dob', 'DoB')
		-> display_as('participant_age', 'Age')
		-> display_as('participant_youth', 'Youth')
		-> display_as('participant_district', 'District'); 
