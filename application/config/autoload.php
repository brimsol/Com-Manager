...
$autoload['sparks'] = array('ci_alerts/1.1.7','ion_auth/2.4.0');
...
| -------------------------------------------------------------------
| 
| Add DB Constants (db.constants.php) - Contain Database Constants
| 	
| Add Site Contants (site.constants.php) - Contains Site Constants
| 
| 
|
*/
